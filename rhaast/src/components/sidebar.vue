<template>
  <div id="left_menu">
    <div class="info">
      <img src="../assets/img/mmexport1504256854011.d62ebe8.png" alt="head">
      <div class="info_name">CHAOHANG</div>
      <div class="archive">
        <ul>
          <router-link to="/article">
            <li>
              <span class="archive_count">{{articleNum}}</span>
    ...
    <nav>
      <ul>
        ...
        <router-link to="/articleList" active-class="active">
          <li class="nav">
            <span>归档</span>
          </li>
        </router-link>
        <router-link to="/articleEdit" active-class="active">
          <li class="nav">
            <span>留言板</span>
          </li>
        </router-link>
...
export default {
  ...
  mounted: function() {
    var self = this
    bus.$on('userDefinedEvent', function(articleNum) {
