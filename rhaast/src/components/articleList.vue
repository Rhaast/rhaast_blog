...
<div id="content" class="content">
  <section id="posts" class="posts-collapse">
    <span class="archive-move-on"></span>
        ...
        <div class="collection-title" @click="showMessage">
          <h2 class="archive-year motion-element">2017</h2>
          <p>共计{{articleNum}}篇文章</p>
        </div>
...
import bus from 'vertx3-eventbus-client'
export default{
    data(){
      return{
        nowPage:1,
    ...
    methods:{
      ...
      showMessage:function(){         //传递参数
        this.bus.$emit('userDefinedEvent',this.articleNum);
      }
    }
  }
</script>